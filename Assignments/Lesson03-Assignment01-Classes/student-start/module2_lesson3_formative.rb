class Person
  ...
  def initialize(first_name, last_name)#should take 2 parameters for first_name and last_name
    ...
    @first_name = first_name #REMEMBER, those are _instance_ variables (Local to the object) not _class_ variables (Shared across objects)
    @last_name = last_name
  ...
  def self.search(last_name)
    ...
    @@people.select{|people| last_name == people.last_name}
  end
